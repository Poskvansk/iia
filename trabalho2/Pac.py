...
def getStatusPaciente(paciente):
    ...
    if aux[0] == 's': 
        ...
        paciente.edema_art = 0
        paciente.edema_intd = 0
    ...
    # aux = input("Houve hipertrofia posso colocar mais algumas regras, t colocar mais algumas regras, tnar? (s/n) ")
    # if aux[0] == 's': 
